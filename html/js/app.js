...
const app = new Vue({
    ...
    data: {
        ...
        clothings: {
            first: [
                { img: 'prop_hat.png', event: 'AquiverInventory:ToggleProps', args: ['Hat'] },
                { img: 'prop_glasses.png', event: 'AquiverInventory:ToggleProps', args: ['Glasses'] },
                { img: 'component_mask.png', event: 'AquiverInventory:ToggleClothing', args: ['Mask'] },
                { img: 'component_accessories.png', event: 'AquiverInventory:ToggleClothing', args: ['Neck'] },
                { img: 'component_bag.png', event: 'AquiverInventory:ToggleClothing', args: ['Bag'] },
                { img: 'component_tops.png', event: 'AquiverInventory:ToggleClothing', args: ['Shirt', true] },
                { img: 'prop_watch.png', event: 'AquiverInventory:ToggleProps', args: ['Watch'] },
                { img: 'component_shoes.png', event: 'AquiverInventory:ToggleClothing', args: ['Shoes'] },
            ],
            second: [
                { img: 'hat.png', event: 'AquiverInventory:ToggleProps', args: ['Visor'] }, // ezek a sapka variánsok
                { img: 'prop_ear.png', event: 'AquiverInventory:ToggleProps', args: ['Ear'] },
                { img: 'haircut.png', event: 'AquiverInventory:ToggleClothing', args: ['Hair'] },
                { img: 'undershirt.png', event: 'AquiverInventory:ToggleClothing', args: ['Top'] }, // ez ilyen top stílusok
                { img: 'component_vest.png', event: 'AquiverInventory:ToggleClothing', args: ['Vest'] },
                { img: 'component_gloves.png', event: 'AquiverInventory:ToggleClothing', args: ['Gloves'] },
                { img: 'prop_bracelet.png', event: 'AquiverInventory:ToggleProps', args: ['Bracelet'] },
                { img: 'component_legs.png', event: 'AquiverInventory:ToggleClothing', args: ['Pants', true] },
            ]
        },
        ...
        settings: {
            ...
            setters: {
                ...
                weightbg_1: {
                    ...
                    color: true,
                    set: localStorage['weightbg_1'] == undefined ? 'rgb(255,255,255)' : localStorage['weightbg_1'],
                    default: 'rgb(255,255,255)'
                },
                weightbg_2: {
                    name: _U('settings_weightbg_2'),
                    color: true,
                    set: localStorage['weightbg_2'] == undefined ? 'rgb(144, 238, 144)' : localStorage['weightbg_2'],
    ...
    watch: {
        'settings.setters.blur.set': function (state) {
            this.sendEvent('nui:AquiverInventory:blurState', state)
        },
        opened(state) {
            this.sendEvent('nui:AquiverInventory:openedState', {
                state: state,
    ...
    mounted: function () {
        ...
        this.sendEvent('nui:AquiverInventory:mounted')
    },
    methods: {
        charImage() {
            if (this.isMale) return 'url(img/char_male.png)'
            else return 'url(img/char_female.png)'
        },
        clothingEvent(a) {
            this.sendEvent(a.event, a.args);
        },
        ...
        giveItemToTarget(targetSrc) {
            ...
            if (ref && ref.inventoryType == 'main') {
                if (this.mainInventory[ref.inventoryIndex]) {
                    ...
                    this.sendEvent('nui:AquiverInventory:giveItemToTarget', {
        ...
        useItem() {
            if (this.draggedData.inventoryType == 'main') {
                if (this.mainInventory[this.draggedData.inventoryIndex]) {
                    ...
                    this.sendEvent('nui:AquiverInventory:useItem', parseInt(this.draggedData.inventoryIndex + 1))
                }
            }
        },
        throwItem() {
            if (this.draggedData.inventoryType == 'main') {
                if (this.mainInventory[this.draggedData.inventoryIndex]) {
                    ...
                    this.sendEvent('nui:AquiverInventory:throwItem', {
            ...
            if (this.draggedData.inventoryType == 'main') {
                if (this.mainInventory[this.draggedData.inventoryIndex]) {
                    ...
                    if (inventoryType == 'second') { // áthúzás second
                        this.sendEvent('nui:AquiverInventory:moveToSecond', {
                            count: darab,
                            index: this.draggedData.inventoryIndex + 1,
                            droppedTo: index + 1
                        })
                        ...
                        this.sendEvent('nui:AquiverInventory:moveInside', {
                            count: darab,
                            index: this.draggedData.inventoryIndex + 1,
                            droppedTo: index + 1,
                            inventoryType: 'main'
                ...
                if (this.secondInventory[this.draggedData.inventoryIndex]) {
                    ...
                    if (inventoryType == 'main') { // áthúzás inventoryba
                        ...
                        this.sendEvent('nui:AquiverInventory:moveToFirst', {
                            count: darab,
                            index: this.draggedData.inventoryIndex + 1,
                            droppedTo: index + 1
                        })
        ...
        startDrag(inventoryType, index) {
            if (inventoryType == 'main') {
                if (this.shiftPressed) {
                    this.sendEvent('nui:AquiverInventory:instantToSecond', parseInt(index + 1))
                    this.PlaySound('pop.wav')
                }
                else {
                ...
                if (this.shiftPressed) {
                    this.sendEvent('nui:AquiverInventory:instantToMain', parseInt(index + 1))
                    this.PlaySound('pop.wav')
                } else {
